...
HQ_EDGE_ROUTER_PRIVATE_IP = env("HQ_EDGE_ROUTER_PRIVATE_IP")

HQ_ISP_EDGE_ROUTER_PUBLIC_IP = env("HQ_ISP_EDGE_ROUTER_PUBLIC_IP")

EXTENDED_ACL_NAME = "HQ-SITE-1"
...
IPSEC_TRANSFORM_SET_NAME = "HQ-SITE-1"
...
HQ_EDGE_ROUTER_PUBLIC_INTERFACE = env("HQ_EDGE_ROUTER_PUBLIC_INTERFACE")
